    ...
    <body>
      <div class="container" style="max-width: 100%; margin: 0">
        <nav class="navbar navbar-expand-md navbar-dark  card-header" style="background-color : darkmagenta";>
          <a class="navbar-brand" style="font-size: 30px; color: white;font-weight: bold;" href="<?php echo $_SERVER['DOCUMENT_ROOT'];?>index.php"><i class="fas fa-home mr-2"></i>Foodies</a>
