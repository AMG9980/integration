          ...
          <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <a style="font-size: 20px; color: white;font-weight: bold;" class="nav-link" href="\Foodies\homeRole.php"><i class="fas fa-tasks" style= "padding-right:10px"></i>Roles list </span></a>
                </li>
