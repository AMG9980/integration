          ...
          <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  ...
                  <a style="font-size: 20px; color: white;font-weight: bold;" class="nav-link" href="EditTask.php"><i class="fas fa-user-plus mr-2"></i>Edit Role </span></a>
                </li>
...
<div class="card ">
  <div class="card-header">
       ...
       <div class="card-body">
           ...
           <form class="" action="/Foodies/indexRole.php?p=tasks/update_tasks?/.?role" method="post">
