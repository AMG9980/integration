...
<div class="container">
    ...
    <div class="row vertical-gap">
        <div class="col-lg-4">
            <div class="nk-feature-1">
                <div class="nk-feature-icon">
                    <img src="assets/images/foodfast.jpg" alt="">
                </div>
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title"><a href="#">FAST FOOD</a></h3>
                    <h3 class="nk-feature-title text-main-1"><a href="#">View PRODUIT</a></h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4">
            <div class="nk-feature-1">
                <div class="nk-feature-icon">
                    <img src="assets/images/dessert2.html" alt="">
                </div>
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title"><a href="#">DESSERTS</a></h3>
                    <h3 class="nk-feature-title text-main-1"><a href="#">View PRODUIT</a></h3>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="nk-feature-1">
                ...
                <div class="nk-feature-cont">
                    <h3 class="nk-feature-title"><a href="#">????</a></h3>
                    <h3 class="nk-feature-title text-main-1"><a href="#">View PRODUIT</a></h3>
                </div>
            </div>
        </div>
    ...
    <div style = "position: absolute; top: 100%;">
        ...
        <div class="nk-carousel-inner">
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/pizza.jpg" alt="PIZZA">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">PIZZA</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price"> dt 6.00</div>
                    </div>
                </div>
            </div></div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/pasta.jpg" alt="pasta">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">pasta</a></h3>
                        <div class="nk-gap-1"></div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/soup.jpg" alt="soup">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">soup</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 1.00</div>
                    </div>
                </div>
            </div></div>
            ...
            <div>
                ...
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/salad.jpg" alt="salad">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">salad</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 9.00</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/lablebi.jpg" alt="lablebi">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="">lablebi</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 5.00</div>
                    </div>
                </div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/hamburger.jpg" alt="hamburger ">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">hamburger </a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 4.00</div>
                    </div>
                </div>
            </div></div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/chicken nig.jpg" alt="chicken nugget">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">chicken nugget</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 10.00</div>
                    </div>
                </div>
            </div></div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/cookie.jpg" alt="cookies">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">cookies</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 2.99</div>
                    </div>
                </div>
            </div></div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/kafteji.jpg" alt="kafteji">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">kafteji</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 3.00</div>
                    </div>
                </div>
            </div></div>
            ...
            <div><div class="pl-5 pr-5">
                <div class="nk-product-cat-3">
                    <a class="nk-product-image" href="store-product.html">
                        <img src="assets/images2/milkshake.jpg" alt="milkshake">
                    </a>
                    <div class="nk-product-cont">
                        <div class="nk-gap-1"></div>
                        <h3 class="nk-product-title h5"><a href="store-product.html">milkshake</a></h3>
                        <div class="nk-gap-1"></div>
                        <div class="nk-product-price">dt 2.40</div>
                    </div>
                </div>
            </div></div>
    ...
    <div class="nk-gap-3"></div>
    <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Featured</span> FOOD</span></h3>
    <div class="nk-gap"></div>
    <div class="row vertical-gap">
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.html">
                    <img src="assets/images2/pizza2.jpg" alt="PIZZA">
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="store-product.html">PIZZA</a></h3>
                    <div class="nk-gap-1"></div>
    ...
    <span class="nk-product-rating">
        <span class="nk-product-rating-front" style="width: 70%;">
        ...
        <span class="nk-product-rating-back">
            ...
            <i class="far fa-star"></i>
                    ...
                    <div class="nk-gap-1"></div>
                    pizza is one of the most popular dishes in the world if not the most, we care about you and we will serve you the best pizza ever!!
                    <div class="nk-gap-2"></div>
                    <div class="nk-product-price">dt 6.00</div>
                    <div class="nk-gap-1"></div>
                    <a href="store-cart.php?produit=PIZZA&amp;prix=6.00" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.html">
                    <img src="assets/images2/humberger2.jpg" alt="Humburger">
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="store-product.html">Humbu
    ...
    <span class="nk-product-rating">
        ...
        <span class="nk-product-rating-back">
            ...
            <i class="far fa-star"></i>
                    ...
                    <div class="nk-gap-1"></div>
                   people tell you who they are but we ignore it because we want a humburger !!!!
                    <div class="nk-gap-2"></div>
                    <div class="nk-product-price">dt 4.00</div>
                    <div class="nk-gap-1"></div>
                    <a href="store-cart.php?produit=Humberger&amp;prix=4.00" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.html">
                    <img src="assets/images2/cookies2.jpg" alt="cookies">
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="store-product.html">cookies</a></h3>
                    <div class="nk-gap-1"></div>
    ...
    <span class="nk-product-rating">
        ...
        <span class="nk-product-rating-back">
            ...
            <i class="far fa-star"></i>
                    ...
                    <div class="nk-gap-1"></div>
                    want something cool get a cookie!!
                    <div class="nk-gap-2"></div>
                    <div class="nk-product-price">dt 2.00</div>
                    <div class="nk-gap-1"></div>
                    <a href="store-cart.php?produit=cookies&amp;prix=2.00" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Add to Cart</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="nk-product-cat-2">
                <a class="nk-product-image" href="store-product.html">
                    <img src="assets/images2/lablebi2.jpg" alt="lablebi">
                </a>
                <div class="nk-product-cont">
                    <h3 class="nk-product-title h5"><a href="store-product.html">lablebi</a></h3>
                    <div class="nk-gap-1"></div>
    ...
    <span class="nk-product-rating">
        ...
        <span class="nk-product-rating-back">
            ...
            <i class="far fa-star"></i>
                    ...
                    <div class="nk-gap-1"></div>
                    lablebi the cure for the common breakfast 
                    <div class="nk-gap-2"></div>
                    <div class="nk-product-price">dt 4.00</div>
                    <div class="nk-gap-1"></div>
                    <a href="store-cart.php?produit=lablebi&amp;prix=5.00" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">Add to Cart</a>
                </div>
            </div>
        </div>
