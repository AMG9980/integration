...
<!-- END: Footer -->
    ...
    <form class="ajouter" id ="fad" action="restaurant/ajouterpro.php"  method="post" enctype="multipart/form-data" >
...
<label for="nom">i nom: <input type="text" name="nom"  placeholder="nom"  >
...
<label for="id_restaurant" > id_restaurant: <input  type="text" id="id_restaurant" name="v" ></label>

<input type="submit"  value="Supprimer" onclick="supprimer()">
<input type="submit"  value="Modifier" onclick="modifier()">
<script>
        function modifier() {
            var idcommande =document.getElementById("id_restaurant").value;
            alert(idcommande)
            window.open(
              "restaurant/loadbdo_update?id_produit="+idcommande, "_blank");
        }
        function supprimer() {
            var idcommande =document.getElementById("id_produit").value;
            alert(idcommande)
            window.open(
              "restaurant/loadbdo_supp?id_produit="+idcommande, "_blank");
        }
