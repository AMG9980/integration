...
<label for="id_restaurant">id_restaurant: <input type="text" name="id_restaurant" id="2" placeholder="id_restaurant"  >
<label for="id_utilisateur">id_utilisateur: <input type="text" name="id_utilisateur"  placeholder="id_utilisateur" id="3"  >
<label for="date_reservation">date_reservation: <input type="datetime-local" name="date_reservation" id="4" placeholder="date_reservation"   >
