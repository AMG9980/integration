...
<!-- END: Footer -->
    ...
    <form class="ajouter" id ="fad" action="produit/ajouterpro.php"  method="post" enctype="multipart/form-data" >

<h1> AJOUTER UNE produit</h1>

<label for="id_produit"> id_produit: <input type="text"  name="id_produit"  placeholder="id_produit"></label>
<label for="prix"> prix: <input type="text" name="prix"  placeholder="prix" ></label>
<label for="nom"> nom: <input type="text" name="nom"  placeholder="nom"  ></label>
<label for="description">description: <input type="text" name="description"  placeholder="description" step="0.01" min="0" max="50"  ></label>
<label for="quantite">quantite: <input type="number" name="quantite"  placeholder="quantite"  min="0" max="50"  ></label>
<label for="id_categorie">id_categorie: <input type="text" name="id_categorie"  placeholder="id_categorie"   ></label>
<label for="img1">description: <input type="file" name="img1"  placeholder="img" ></label>

<input type="submit"  value="Ajouter">

</form>
<div class="box" >
<h1> afficher UNE produit</h1>
 
<label for="id_produit" > id_produit: <input  type="text" id="id_produit" name="id_produit" ></label>

<input type="submit"  value="Supprimer" onclick="supprimer()">
<input type="submit"  value="Modifier" onclick="modifier()">
<script>
        function modifier() {
            var idcommande =document.getElementById("id_produit").value;
            alert(idcommande)
            window.open(
              "produit/loadbdo_update?id_produit="+idcommande, "_blank");
        }
        function supprimer() {
            var idcommande =document.getElementById("id_produit").value;
            alert(idcommande)
            window.open(
              "produit/loadbdo_supp?id_produit="+idcommande, "_blank");
        }
     ...
     div.innerHTML += ' <label for="prix">prix: <input type="text" name="prix" "placeholder="v" id="b'+i+'" readOnly="readOnly" >'
     div.innerHTML +='<label for="nom">nom: <input type="text" name="nom"  placeholder="nom" id="c'+i+'" readOnly="readOnly" >'
     div.innerHTML +='<label for="id_categorie">id_categorie: <input type="text" name="id_categorie"  placeholder="id_categorie"  id="d'+i+'" readOnly="readOnly">'
               
     document.body.appendChild(div);
          document.getElementById('b'+i).value = row["prix"];
              document.getElementById('c'+i).value = row["nom"];
     
          document.getElementById('d'+i).value = row["id_categorie"];
