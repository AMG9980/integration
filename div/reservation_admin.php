...
<!-- END: Footer -->
    ...
    <form class="ajouter" id ="fad" action="reservation/ajouterliv.php"  method="post" enctype="multipart/form-data" >

<h1> AJOUTER UNE reservation</h1>
<label for="id_reservation">id_reservation: <input type="text"  name="id_reservation"  placeholder="id_reservation "  ></label>
...
<label for="date_reservation">date_reservation: <input type="datetime-local" name="date_reservation"  placeholder="date_reservation"   ></label>

<input type="submit"  value="Ajouter">

</form>
<div class="box" >
<h1> afficher UNE reservation</h1>
 
<label for="id_reservation" > id_reservation: <input  type="text" id="id_reservation" name="v" ></label>

<input type="submit"  value="Supprimer" onclick="supprimer()">
<input type="submit"  value="Modifier" onclick="modifier()">
<script>
        function modifier() {
            var idcommande =document.getElementById("id_reservation").value;
            alert(idcommande)
            window.open(
              "reservation/loadbdo_updatel?id_reservation="+idcommande, "_blank");
        }
        function supprimer() {
            var idcommande =document.getElementById("id_reservation").value;
            alert(idcommande)
            window.open(
              "reservation/loadbdo_suppl?id_reservation="+idcommande, "_blank");
        }
     ...
     div.id = 'container';
         div.className='box';
           ...
           div.innerHTML += ' <label for="id_reservation">id_reservation: <input type="text" name="id_reservation" "placeholder="v" id="a'+i+'" readOnly="readOnly" >'
          
     div.innerHTML += ' <label for="id_restaurant">id_restaurant: <input type="text" name="id_restaurant" "placeholder="v" id="b'+i+'" readOnly="readOnly" >'
     ...
     div.innerHTML +='<label for="v">adresse: <input type="text" name="date_reservation"  placeholder="date_reservation"  id="d'+i+'" readOnly="readOnly">'
               
     document.body.appendChild(div);
     document.getElementById('a'+i).value = row["id_reservation"];

          document.getElementById('b'+i).value = row["id_restaurant"];
              document.getElementById('c'+i).value = row["id_utilisateur"];
     
          document.getElementById('d'+i).value = row["date_reservation"];
...
<h1>AFFICHAGE DES reservation </h1>
