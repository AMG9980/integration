...
label for="id_produit"> id_produit: <input type="text" id="1" name="id_produit"  placeholder="id_produit"></label>
...
<label for="description">description: <input type="text" id="4" name="description"  placeholder="description" step="0.01" min="0" max="50"  ></label>
