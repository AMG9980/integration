...
for($i=0;$i<count($_SESSION['count']);$i++){
    $somme= $somme+(((int)$_SESSION['count'][$i][1])*((int)$_SESSION['count'][$i][2]));


}
echo $somme+6;
$_SESSION['total']=$somme+6;
...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        ...
        <form action="finalcheckout.php" class="nk-form" method="post">
            <div class="row vertical-gap">
                <div class="col-lg-6">
                    <div class="row vertical-gap">
                        <div class="col-sm-6">
                            <label for="fname">First Name <span class="text-main-1">*</span>:</label>
                            <input style="background:none;" type="text" class="form-control required" name="nom" id="nom" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label for="lname">Last Name <span class="text-main-1">*</span>:</label>
                            <input type="text" style="background:none;" class="form-control required" name="prenom" id="prenom" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row vertical-gap">
                        <div class="col-sm-6">
                            ...
                            <input type="email" style="background:none;" class="form-control required" name="email" id="email" readonly>
                        </div>
                        <div class="col-sm-6">
                            <label for="phone">Phone <span class="text-main-1">*</span>:</label>
                            <input type="tel" style="background:none;" class="form-control required" name="phone" id="phone" readonly>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <input type="text" style="background:none;" class="form-control required" name="adresse" id="adresse" readonly>

                    <div class="nk-gap-1"></div>
                    <label for="city">region <span class="text-main-1">*</span>:</label>
                    <input type="text" style="background:none;" class="form-control required" name="region" id="region" readonly>

                    <div class="nk-gap-1"></div>
                    <div class="row vertical-gap">
                        <div class="col-sm-6">
                            <label for="state">State / Country <span class="text-main-1">*</span>:</label>
                            <input type="text" style="background:none;" class="form-control required" name="state" id="state" value="TUNISIA" readonly="readonly">
                        </div>
                        <div class="col-sm-6">
                            <label for="zip">Postcode / ZIP <span class="text-main-1">*</span>:</label>
                            <input type="tel"  style="background:none;" class="form-control required" name="zip" id="zip" readonly>
                        </div>
                    </div>
...
function create(){
    ...
    var adresse='<?php echo json_encode($_POST['adresse']); ?>;'
    ...
    var phone='<?php echo json_encode($_SESSION['phone']); ?>;'
    phone=phone.replace(";","");
    phone=phone.replace('"','');
    phone=phone.replace('"','');

    var region='<?php echo json_encode($_POST['region']); ?>;'
    region=region.replace(";","");
    region=region.replace('"','');
    region=region.replace('"','');

    var zip='<?php echo json_encode($_POST['zip']); ?>;'
    zip=zip.replace(";","");
    zip=zip.replace('"','');
    zip=zip.replace('"','');
...
var rt=document.createElement('tr');
                        rt.innerHTML='<td class="nk-product-cart-title">'+row[i][0] +' &times;'+ row[i][1]+' </td>'
                        rt.innerHTML+='<td class="nk-product-cart-total">'+(parseInt(row[i][2])*parseInt(row[i][1]))+' </td>'
                        document.getElementById('tbody10').appendChild(rt);

somme +=(parseInt(row[i][2])*parseInt(row[i][1]))
                        }
                        
                        var subtotal=document.createElement('tr');
                        subtotal.innerHTML='<td class="nk-product-cart-title">Subtotal </td>'
                        subtotal.innerHTML+='<td class="nk-product-cart-total"> '+somme+'</td>'
                        document.getElementById('tbody10').appendChild(subtotal);
                        var delivery=document.createElement('tr');
                        delivery.innerHTML='<td class="nk-product-cart-title">delivery </td>'
                        delivery.innerHTML+='<td class="nk-product-cart-total"> 6dt</td>'
                        document.getElementById('tbody10').appendChild(delivery);
                        var total=document.createElement('tr');
                        total.innerHTML='<td class="nk-product-cart-title">Total</td>'
                        total.innerHTML+='<td class="nk-product-cart-total"> '+(somme+6)+ '</td>'
                        document.getElementById('tbody10').appendChild(total);
