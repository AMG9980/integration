...
<!-- END: Footer -->
    ...
    <form class="ajouter" id ="fad" action="categorie/ajouterliv.php"  method="post" enctype="multipart/form-data" >

<h1> AJOUTER UNE categorie</h1>
<label for="id_catalog">id_catalog: <input type="text"  name="id_catalog" id="1" placeholder="id_catalog "  ></label>
<label for="nom">nom: <input type="text" name="nom" id="2" placeholder="nom"   ></label>
<label for="desc">texte: <input type="text" name="desc"  placeholder="desc" id="3"   ></label>
...
<label for="id_catalog" > id_catalog: <input  type="text" id="id_catalog" name="v" ></label>

<input type="submit"  value="Supprimer" onclick="supprimer()">
<input type="submit"  value="Modifier" onclick="modifier()">
<script>
        function modifier() {
            var idcommande =document.getElementById("id_catalog").value;
            alert(idcommande)
            window.open(
              "categorie/loadbdo_updatel?id_catalog="+idcommande, "_blank");
        }
        function supprimer() {
            var idcommande =document.getElementById("id_catalog").value;
            alert(idcommande)
            window.open(
              "categorie/loadbdo_suppl?id_catalog="+idcommande, "_blank");
        }
     ...
     div.id = 'container';
         div.className='box';
           div.innerHTML='<h>catalog'+(i+1)+'</h>'
          
     div.innerHTML += ' <label for="id_catalog">id_catalog: <input type="text" name="id_catalog" "placeholder="v" id="b'+i+'" readOnly="readOnly" >'
     div.innerHTML +='<label for="nom">nom: <input type="text" name="nom"  placeholder="nom" id="c'+i+'" readOnly="readOnly" >'
     div.innerHTML +='<label for="desc">desc: <input type="text" name="desc"  placeholder="desc"  id="d'+i+'" readOnly="readOnly">'
               
     document.body.appendChild(div);

          document.getElementById('b'+i).value = row["id_catalog"];
              document.getElementById('c'+i).value = row["nom"];
     
          document.getElementById('d'+i).value = row["desc"];
